    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="#" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                        class="fas fa-tachometer-alt me-2"></i>Panel de usuario</a>
        ...
        <div id="page-content-wrapper">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle second-text fw-bold" href="#" id="navbarDropdown"
                                ...
                                <i class="fas fa-user me-2"></i><?php echo e(auth()->user()->name ?? auth()->user()->email); ?>
            ...
            <div class="container-fluid px-4">
                ...
                <?php echo $__env->make('layouts.partials.crud', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/vadym/Escritorio/DSS/dss/resources/views/layouts/app-master.blade.php ENDPATH**/ ?>